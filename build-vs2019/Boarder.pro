...
macx {
	...
	CONFIG(debug, debug|release) {
    		message("debug mode")
	    	LIBS += $$GF/GameEngine/XCode/GameFusion\\ Static\\ Library/build/Debug/libOSX\\ Library.a
	
	}else {
    		message("release mode")
    		LIBS += $$GF/GameEngine/XCode/GameFusion\\ Static\\ Library/build/Release/libOSX\\ Library.a
	}
