...
win32 {
   ...
   CONFIG(debug, debug|release) {
	   DEFINES += DEBUG
		...
		LIBS	+= ..\..\GameEngine\build-vs2019\Debug\GameEngine.lib ..\..\GameEngine\build-vs2019\Debug\GameEngineGL.lib ..\..\GameEngine\build-vs2019\Debug\GameFramework.lib
		...
		SOURCES += ../../Projects/PhoneDEC/dec_phone_corr/Phone.cpp
		SOURCES += ../../Projects/PhoneDEC/dec_phone_corr/DEC.cpp
		 LIBS += ..\..\ExternalLibs\libjpeg-win64-vs2019\x64\Debug\jpeg.lib
		LIBS += ../../ExternalLibs/libpng-1.6.24/build-win64-vs2019/Debug/libpng16_staticd.lib
		LIBS += ../../ExternalLibs/zlib-vs2019/Debug/zlib.lib
	} else {
		LIBS	+= ..\..\GameEngine\x6build-vs2019\Release\GameEngine.lib ..\..\GameEngine\x6build-vs2019\Release\GameEngineGL.lib ..\..\GameEngine\x6build-vs2019\Release\GameFramework.lib
		LIBS += ../../ExternalLibs/harmonicBlender/x64/Release/harmonicBlender.lib
		LIBS += ../../ExternalLibs/libharu-2.1.0-vs2019/x64/Release/libharu.lib
		SOURCES += ../../Projects/PhoneDEC/dec_phone_corr/Phone.cpp
		SOURCES += ../../Projects/PhoneDEC/dec_phone_corr/DEC.cpp
		LIBS += ..\..\ExternalLibs\libjpeg-win64-vs2019\x64\Release\jpeg.lib
		LIBS += ../../ExternalLibs/libpng-1.6.24/build-win64-vs2019/Release/libpng16_static.lib
		LIBS += ../../ExternalLibs/zlib-vs2019/Release/zlib.lib
		LIBS += comdlg32.lib
   }

   LIBS += ..\..\ExternalLibs\ffmpeg-20200806-2c35797-win64-dev\lib\avformat.lib
   LIBS += ..\..\ExternalLibs\ffmpeg-20200806-2c35797-win64-dev\lib\avcodec.lib
   LIBS += ..\..\ExternalLibs\ffmpeg-20200806-2c35797-win64-dev\lib\avutil.lib
   LIBS += ..\..\ExternalLibs\ffmpeg-20200806-2c35797-win64-dev\lib\swscale.lib
   SOURCES += ../../GameEngine/GenericDevice/GenericDevice.cpp
   SOURCES += ../../GameEngine/GenericDevice/GenericInput.cpp
}
