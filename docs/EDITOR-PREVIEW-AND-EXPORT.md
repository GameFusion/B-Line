...
- PaintCanvasSmoke: 47 checks, including both drawing origins, held-gesture deferral, rapid strokes, late completion after panel navigation, focus loss, thumbnail suspension, export overlay isolation and frame formatting. Cached 300-stroke native workspace redraw measured approximately 2.7 ms/frame in this fixture; this is not a full interactive latency benchmark.
- PlaybackSmoke: 24 checks with native audio enabled, including silent transport, pause/resume/stop/loop/seek, Shot List controls, 200 px docks, audio attachment without scrubbing and sample consumption. The synthetic tone produced a meter reading around -28 dB.
